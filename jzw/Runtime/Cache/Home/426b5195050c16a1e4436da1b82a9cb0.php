...
<img src="/Public/image/logo.jpg">
	...
	<form action="/index.php/User/revise" method="post">
	<table class="bluetable" style="margin:0px auto;">
		...
		<tr><td>新密码<span style="color:red">*</span></td>
			<td><input type="password" name="password" maxlength="32" size="20"/></td>
		</tr>
		<tr><td>邮箱<span style="color:red">*</span></td>
			<td><input type="text" name="mail" class="email" onblur="checkmail()" maxlength="18" size="20" required="required" value="<?php echo ($mail); ?>" /><span class="mailcheck"></span></td>
		</tr>
		<tr><td>所在地区：<span style="color:red">*</span></td>
			<td><input type="text" id="city-picker" name="positionname" value="<?php echo ($postionname); ?>" readonly="readonly" /></td>
		</tr>
    ...
    cityPicker.init();</script>
		<tr><td>密保问题：<span style="color:red">*</span></td>
			<td><input type="text" name="question" maxlength="20" size="20" required="required" value="<?php echo ($question); ?>" /></td>
		</tr>
		<tr><td>密保答案：<span style="color:red">*</span></td>
			<td><input type="text" name="answer" maxlength="20" size="20" required="required" value="<?php echo ($answer); ?>" /></td>
		</tr>
